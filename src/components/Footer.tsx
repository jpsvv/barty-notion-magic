...
const footerLinks = {
  Soluções: [
    { label: "Barty Ficha", href: "/fichas" },
    { label: "Barty Eventos", href: "/eventos" },
    { label: "Barty Food", href: "/food" },
    { label: "Barty Ingressos", href: "/ingressos" },
  ],
  Empresa: [
  ...
  Contato: [
    ...
    { label: "Instagram", href: "https://instagram.com/bartyapp", external: true },
  ],
};
                  ...
                  <li key={link.label}>
                    {"external" in link && link.external ? (
                      <a
                        ...
                        className="text-sm text-background/45 hover:text-background/80 transition-colors"
                      >
                        {link.label}
                      </a>
                    ) : (
        ...
        <div className="border-t border-background/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-background/35 hover:text-background/70 transition-colors"
              aria-label="WhatsApp"
            >
            ...
            <a
              href="https://instagram.com/bartyapp"
              target="_blank"
              rel="noopener noreferrer"
              className="text-background/35 hover:text-background/70 transition-colors"
